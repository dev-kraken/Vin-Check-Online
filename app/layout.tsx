...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <meta name="twitter:title" content="VIN Check Online" key="twitter-title" />
      <meta name="twitter:description" content="Check Vehicle Information Online" />
      ...
      <meta property="og:description" content="Check Vehicle Information Online" />
